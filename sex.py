...
\033[1;97m= = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
\033[1;39m┌──────────────────────── ADMIN ────────────────────────┐
\033[1;32m║   \033[1;39mPYTHON VERSION\033[1;32m 3.12                                   \033[1;32m║
...
def hien_thi_intro():
    os.system('cls' if os.name == 'nt' else 'clear')
    intro_messages = [
        "ADMIN PHƯỚC CHÀO BẠN ĐÃ ĐẾN VỚI TOOL 💥",
        "TOOL HỖ TRỢ DỰ ĐOÁN TỈ SỐ VUA THOÁT HIỂM CHÍNH XÁC LÊN ĐẾN 90% ⚠️",
        "ADMIN PHƯỚC XIN ĐƯỢC PHÉP BẮT ĐẦU TOOL 💢",
        "NHẬP TÊN PHÒNG VIẾT TẮT MÀ SÁT THỦ ĐÃ VÀO TRẬN TRƯỚC ❗"
        "MUA FULL SCR VIP CỰC RẺ LIÊN HỆ ZALO 0915948201 30K DÙNG VĨNH VIỄN🎭 !"
    ]
